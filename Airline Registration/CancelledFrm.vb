...
Public Class CancelledFrm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select bNo,Date,CustomerName,FlightNo,price From BookingTable where tstatus='C' order by bNo", conn)
        adp.Fill(DS1)
    ...
    Private Sub CancelledFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
